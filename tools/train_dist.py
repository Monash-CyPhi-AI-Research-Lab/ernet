...
def main_per_worker():
    ...
    #                 not match_name_keywords(n, relation_names) and
    #              p.requires_grad],
    #         "lr": cfg.TRAIN.LR,
    #     },
    ...
    #         "params":
    #             [p for n, p in model_without_ddp.named_parameters()
    #              if match_name_keywords(n, relation_names) and
    #                 not match_name_keywords(n, backbone_names) and 
    #                 not match_name_keywords(n, linear_proj_names) and
    #              p.requires_grad],
    #         "lr": cfg.TRAIN.LR,
    #     },
    ...
    #         "params": [p for n, p in model_without_ddp.named_parameters() 
    #               if match_name_keywords(n, linear_proj_names) and 
    #                  match_name_keywords(n, relation_names) and
    #               p.requires_grad],
    #         "lr": cfg.TRAIN.LR * cfg.TRAIN.LR_LINEAR_PROJ_MULT,
    #     },
    # ]
    ...
    if cfg.TRAIN.RESUME:
        ...
        lr_scheduler = get_lr_scheduler(cfg, optimizer)
        lr_scheduler.last_epoch = last_iter + 1
    ...
    while True:            
        ...
        if Trainer.epoch >= 40 and step == 'Pre-train':
            step = 'Fine-tune'
            print('Stage: {}'.format(step))
            train_dataset, eval_dataset = get_dataset(cfg, step)
            train_loader = torch.utils.data.DataLoader(
            ...
            optimizer.param_groups[0]["lr"] = cfg.TRAIN.LR * 0.1
            optimizer.param_groups[1]["lr"] = cfg.TRAIN.LR * 0.1
